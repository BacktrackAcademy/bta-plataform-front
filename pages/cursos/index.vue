    ...
    <div class="bg-bta-section">
      <div>
        ...
        <main class="max-w-7xl mx-auto sm:px-6">
          <div class="relative z-10 flex items-baseline justify-between pt-24 pb-6 border-b border-gray-border">
            <h1 class="text-4xl font-semibold tracking-tight text-white font-oswald">Catálogo de cursos</h1>
            <div class="flex items-center">
              <div class="relative inline-block text-left">
                <div>
                  <button type="button" class="group inline-flex justify-center text-sm font-medium text-white hover:text-gray-900" id="menu-button" aria-expanded="false" aria-haspopup="true">
                    Sort
          ...
          <section aria-labelledby="products-heading" class="pt-6 pb-24">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-4 gap-x-8 gap-y-10">
              ...
              <form class="hidden lg:block">
                <h3 class="sr-only">Categories</h3>
                <ul role="list" class="text-sm font-medium font-inconsolata text-white space-y-4 pb-6 border-b border-gray-border">
                  <li>
                    <a href="#"> Todos </a>
                  </li>

                  <li>
                    <a href="#"> Más Popular </a>
                  </li>

                  <li>
                    <a href="#"> Últimos publicados </a>
                  </li>
                ...
                <div class="border-b border-gray-border py-6">
                  <h3 class="-my-3 flow-root">
                    <!-- Expand/collapse section button -->
                    <button type="button" class="py-3 w-full flex items-center justify-between text-sm text-gray-400 hover:text-gray-500" aria-controls="filter-section-0" aria-expanded="false">
                      <span class="font-medium text-white font-oswald"> Dificultad </span>
                      <span class="ml-6 flex items-center">
                        <!--
                          Expand icon, show/hide based on section open state.
                    ...
                    <div class="space-y-4">
                      ...
                      <div v-for="(level, i) in levels" :key="i" >
                        <div class="flex items-center gap-2">
                          ...
                          <label for="filter-size-0" class="ml-3 text-sm text-gray-muted font-inconsolata hover:text-white">{{ level.name }}</label>
                          <label class="text-gray-muted font-inconsolata hover:text-white">{{ level.number_courses }}</label>
                        </div>
                      </div>
                    </div>
                  </div>
                ...
                <div class="border-b border-gray-border py-6">
                  <h3 class="-my-3 flow-root">
                    ...
                    <button type="button" class="py-3 w-full flex items-center justify-between text-sm text-gray-400 hover:text-gray-500" aria-controls="filter-section-1" aria-expanded="false">
                      <span class="font-medium text-white font-oswald"> Categorías </span>
                      <span class="ml-6 flex items-center">
                        <!--
                          Expand icon, show/hide based on section open state.
                  ...
                  <div class="pt-6" id="filter-section-1">
                    <div class="space-y-4">
                      <div v-for="(category, i) in categories" :key="i" >
                        <div class="flex items-center gap-2">
                          <input id="filter-size-0" name="size[]" value="2l" type="checkbox" class="h-4 w-4 border-gray-300 rounded text-indigo-600 focus:ring-indigo-500">
                          <label for="filter-size-0" class="ml-3 text-sm text-gray-muted font-inconsolata hover:text-white">{{ category.name }}</label>
                          <label class="text-gray-muted font-inconsolata hover:text-white">{{ category.number_courses }}</label>
                        </div>
                      </div>
                    </div>
                  </div>
                ...
                <div class="border-b border-gray-200 py-6">
                  <h3 class="-my-3 flow-root">
                    <!-- Expand/collapse section button -->
                    <button type="button" class="py-3 w-full flex items-center justify-between text-sm text-gray-400 hover:text-gray-500" aria-controls="filter-section-2" aria-expanded="false">
                      <span class="font-medium text-white font-oswald"> Docentes </span>
                      <span class="ml-6 flex items-center">
                        <!--
                          Expand icon, show/hide based on section open state.
                  ...
                  <div class="pt-6" id="filter-section-2">
                    <div class="space-y-4">
                      ...
                      <div v-for="(teacher, i) in teachers" :key="i" >
                        <div class="flex items-center">
                          <input id="filter-size-0" name="size[]" value="2l" type="checkbox" class="h-4 w-4 border-gray-300 rounded text-indigo-600 focus:ring-indigo-500">
                          <label for="filter-size-0" class="ml-3 text-sm text-gray-muted font-inconsolata hover:text-white"> {{ teacher.name }} {{ teacher.lastname }} </label>
                          <label class="text-gray-muted font-inconsolata hover:text-white">{{ teacher.number_courses }}</label>
                        </div>
                      </div>
                    </div>
                  </div>
                        ...
                        <div class="flex flex-col h-full bg-bta-dark-blue shadow-lg rounded-lg overflow-hidden">
                          ...
                          <div class="flex-grow flex flex-col p-5">
                            ...
                            <div class="flex-grow">
                              ...
                              <header class="mb-3">
                                <a class="block focus:outline-none focus-visible:ring-2" href="#0">
                                  <h3 class="text-[22px] font-extrabold leading-snug font-oswald text-white">{{ course.titulo }}</h3>
                                </a>
                              </header>
                              <!-- Content -->
                            ...
                            <div class="flex justify-end space-x-2">
                              <a class="font-inconsolata text-sm inline-flex items-center justify-center px-3 py-1.5 rounded leading-5 text-gray-muted hover:underline focus:outline-none focus-visible:ring-2" href="#0">{{ course.total_length }}</a>
                              <NuxtLink 
                              ...
                              <a class="font-semibold text-sm inline-flex items-center justify-center px-3 py-1.5 border border-transparent rounded leading-5 shadow-sm transition duration-150 ease-in-out bg-indigo-500 focus:outline-none focus-visible:ring-2 hover:bg-indigo-600 text-white" href="#0">Comprar</a>
                            </div>
                          </div>
                        </div>
                      </div>
